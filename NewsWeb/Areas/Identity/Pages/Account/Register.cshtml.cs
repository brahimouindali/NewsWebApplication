    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (!await _roleManager.RoleExistsAsync(RoleName.AdminsRole))
                {
                ...
                if (result.Succeeded)
                {
                    if (roleName == RoleName.AdminsRole)
                    {
                        await _userManager.AddToRoleAsync(user, RoleName.AdminsRole);
                    }
                    else
                    {
                        if (roleName == RoleName.WritersRole)
                        {
                            await _userManager.AddToRoleAsync(user, RoleName.WritersRole);
                        }
                        else
                        {
